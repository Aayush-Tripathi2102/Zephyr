  ...
  return (
    <div className="flex h-screen">
      <div className="w-1/2 flex items-center justify-center relative">
        ...
        <div className="w-[500px] bg-gradient-to-b from-purple-900/30 to-purple-900/10 p-8 md:p-12 rounded-3xl border border-purple-500/30 backdrop-blur-sm">
